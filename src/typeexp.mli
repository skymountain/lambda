...
val err           : string -> 'a
val replace_tyvar : Type.typ Typevar.TypvarMap.t -> Type.typ -> Type.typ
...
val local_unify   : ?init:Type.typ Typevar.TypvarMap.t -> Type.typ -> Type.typ -> Type.typ Typevar.TypvarMap.t option
